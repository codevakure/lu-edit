...
>(
  (
    ...
    const contextValue = React.useMemo<SidebarContext>(
      ...
      [state, open, setOpen, openMobile, setOpenMobile, isMobile, toggleSidebar, defaultOpen],
    );
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            data-sidebar="sidebar"
            data-mobile="true"
            className="w-[--sidebar-width] p-0 text-sidebar-foreground [&>button]:hidden !bg-sidebar border-sidebar-border"
            style={
              {
