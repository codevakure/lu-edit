...
import { getIconComponent } from "../../../utils/iconPreloader";
    ...
    (
      ...
      useEffect(() => {
        ...
        if (name && typeof name === "string") {
          // Try preloaded icons first, then fallback to regular loading
          getIconComponent(name)
            ...
            .catch((error) => {
              ...
              getNodeIcon(name)
                ...
                .catch((fallbackError) => {
                  if (isMounted) {
                    console.error(`Error loading icon ${name}:`, fallbackError);
                    setIconError(true);
                    setShowFallback(false);
                  }
                });
