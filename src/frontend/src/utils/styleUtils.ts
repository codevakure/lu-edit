...
// Import critical Lucide icons for eager loading
const eagerLucideIcons = {
  ...
  BrainCog: lazy(() => import('lucide-react').then(mod => ({ default: mod.BrainCog }))),
  Cable: lazy(() => import('lucide-react').then(mod => ({ default: mod.Cable }))),
  ...
  Square: lazy(() => import('lucide-react').then(mod => ({ default: mod.Square }))),
